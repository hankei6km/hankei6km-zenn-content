...
`@` によるリマインダーで通知させる場合は、リポジトリのページをフォローしている必要があります。フォローは各ページ右上の時計アイコンから行えます。

![ページの履歴を表示し、フォローボタンに赤い下線を付けているスクリーンショット](https://images.microcms-assets.io/assets/1fff6177c5c74aac8d5158dc17492c92/380c5251533446df83a1ad7360755b81/send-a-repo-list-to-notion-database-follow.png?w=401\&h=211\&auto=compress%2Cformat)

できればページを作成するときにツールからフォロー状態にしたかったのですが、Notion AI に訪ねても実現方法がわかりませんでした。今回はあきらめて、テンプレートに「ページをフォローすること」という文言を手動で入れることにより対応しています。
